...
import { X, SlidersHorizontal, Check, Volume2, VolumeX, RotateCcw } from 'lucide-react';
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-xl overflow-y-auto">
        ...
        >
          ...
          <p className="text-xs sm:text-sm text-slate-400 mb-6 leading-relaxed">
            Configure the categories you wish to calibrate. The roller wheels will bias toward your chosen focus areas during random selections.
          </p>
                ...
                <button
                  ...
                  className={`p-3 rounded-2xl border text-left flex items-center justify-between transition-all ${
                    isSelected
                      ...
                      : 'bg-black/40 border-white/[0.06] text-slate-400 hover:border-white/[0.12]'
                  }`}
                >
